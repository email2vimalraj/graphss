...
//
// Any non-application error (such as disk error) should be reported as an
...
func (e *Error) Error() string {
	return fmt.Sprintf("graphss error: code=%s message=%s", e.Code, e.Message)
}

// ErrorCode unwraps an application error and returns the error code.
// Non-application erors always return EINTERNAL.
...
// ErrorMessage unwraps an application error and returns the error message.
// Non-application erors always return "Internal error".
